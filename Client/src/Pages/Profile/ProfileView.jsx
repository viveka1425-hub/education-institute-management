        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h2 className="text-3xl font-bold text-pink-900 mb-1">Institute Profile</h2>
                        <p className="text-gray-500">View and manage your institution details</p>
                    </div>
                    <div className="flex gap-3">
                        <Link
                            onClick={() => handleEditProfile(profile._id)}
                            //to={`/profile/edit/${profile.id}`}
                            className="px-6 py-2.5 rounded-lg bg-gradient-to-r from-[#b7589f] to-[#b7589f] text-white font-medium shadow-lg shadow-pink-500/30 hover:shadow-xl hover:shadow-pink-500/40 transform hover:-translate-y-0.5 transition-all duration-200"
                        >
                        ...
                        <Link
                            ...
                            className="px-6 py-2.5 rounded-lg border-2 border-[#b7589f] text-[#b7589f] font-medium hover:bg-[#b7589f] hover:text-white transition-all duration-200"
                        >
                ...
                {profile ? (
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                        ...
                        <div className="h-40 bg-gradient-to-r from-[#b7589f] via-[#b7589f] to-[#b7589f] relative overflow-hidden">
                            ...
                            <div className="flex flex-col md:flex-row gap-8 -mt-28 relative">
                                ...
                                <div className="flex-1 pt-20 md:pt-0">
                                    ...
                                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="bg-gradient-to-br from-pink-50 to-indigo-50 rounded-xl p-5 border border-pink-100">
                                            <div className="flex items-center mb-3">
                                                <div className="h-10 w-10 rounded-lg bg-gradient-to-r from-[#b7589f] to-[#b7589f] flex items-center justify-center mr-3">
                                            ...
                                            <div className="space-y-2 text-sm">
                                                <div className="flex items-center text-gray-700">
                                                    <svg className="w-4 h-4 mr-2 text-[#b7589f]" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <div className="bg-gradient-to-br from-[#b7589f] to-[#b7589f] rounded-lg p-4 shadow-lg hover:shadow-xl transition-all">
                            ...
                            {profile.gallery && profile.gallery.length > 0 && (
                                <div className="mt-10 pt-8 border-t border-gray-200">
                                    <div className="flex items-center mb-5">
                                        <div className="h-10 w-10 rounded-lg bg-gradient-to-r from-[#614b97] to-[#7256b8] flex items-center justify-center mr-3">
                                            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            </svg>
                                        </div>
