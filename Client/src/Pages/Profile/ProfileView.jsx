        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h2 className="text-3xl font-bold text-gray-900 mb-1">Institute Profile</h2>
                    ...
                    <div className="flex gap-3">
                        ...
                        <Link
                            ...
                            className="px-6 py-2.5 rounded-lg border-2 border-[#7256b8] text-[#7256b8] font-medium hover:bg-[#7256b8] hover:text-white transition-all duration-200"
                        >
                ...
                {profile ? (
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                        ...
                        <div className="h-40 bg-gradient-to-r from-[#614b97] via-[#7256b8] to-[#8c6ec7] relative overflow-hidden">
                            ...
                            <div className="flex flex-col md:flex-row gap-8 -mt-28 relative">
                                ...
                                <div className="flex-1 pt-20 md:pt-0">
                                        ...
                                        <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-5 border border-purple-100">
                                            ...
                                            <div className="space-y-2 text-sm">
                                                <div className="flex items-center text-gray-700">
                                                    <svg className="w-4 h-4 mr-2 text-[#7256b8]" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <div className="bg-gradient-to-br from-[#614b97] to-[#7256b8] rounded-lg p-4 shadow-lg hover:shadow-xl transition-all">
