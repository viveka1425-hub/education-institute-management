        ...
        <div className="grid md:grid-cols-2 gap-6">
          {courses.map((c) => (
            ...
            >
              ...
              <div className="h-2 bg-gradient-to-r from-[#614b97] to-[#7256b8]"></div>

              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start gap-4 flex-1">
                    {/* Category Icon */}
                    <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-[#614b97] to-[#7256b8] flex items-center justify-center text-white flex-shrink-0 shadow-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-600 mb-2">
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full bg-purple-100 text-[#614b97] font-medium">
                          {c.category}
                        </span>
